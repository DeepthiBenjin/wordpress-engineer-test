...
if ( ! class_exists( 'Fitness_Coaching_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Fitness_Coaching_WPTT_WebFont_Loader {
		 ...
		 * @var string
		 */
		protected $fitness_coaching_css;
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Fitness_Coaching_WPTT_WebFont_Loader( $url );
